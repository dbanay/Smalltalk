...
# Linux
You need to install SDL 2.0.12 or later. Head over to http://libsdl.org and download the source code and unpack it.  Follow the build instructions:
`./configure`
`make`
`sudo make install`
